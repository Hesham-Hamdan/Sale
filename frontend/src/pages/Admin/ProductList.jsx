...
const ProductList = () => {
  ...
  return (
    // This component should be placed inside a main content wrapper that handles margins for the navigation
    <div className="container mx-auto p-4">
      <div className="flex flex-col md:flex-row">
        <AdminMenu />
        <div className="lg:w-3/4 w-full p-3 lg:ml-15 lg:mt-0 ml-0 mt-10">
